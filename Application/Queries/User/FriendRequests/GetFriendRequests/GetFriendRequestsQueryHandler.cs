...
public class
    ...
    Either<Error, IEnumerable<GetFriendRequestsQuery.FriendRequest>>>
{
    ...
    public async Task<Either<Error, IEnumerable<GetFriendRequestsQuery.FriendRequest>>> Handle(GetFriendRequestsQuery request,
    ...
    private async Task<IEnumerable<GetFriendRequestsQuery.FriendRequest>> ToResult(ICollection<FriendRequest> friendRequests,
        CancellationToken cancellationToken)
    {
